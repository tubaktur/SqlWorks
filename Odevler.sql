...
--1) ulkelerin yaptığı ciroları görelim?
...
--2)ülkelerin yaptığı ciroları yıllara göre dağıtalım?
select top 10 * from Orders
select top 10 * from [Order Details]


--3)calisanlarin yaptigi ciro nedir (1997 yili)
...
--4)kargo firmalarinin tasidigi siparislerin toplam degeri nedir 
...
--5)kategorilere gore ciro nedir ?
...
--6) 1997 yilindaki cirolarin aylara gore dagilimi nedir ?
